    ...
    try {
      ...
      if (!createResponse.ok) {
        ...
        const isSuspended =
          ...
          /suspend|suspended|account/i.test(message);
        ...
        return NextResponse.json(
          {
            ...
            /*
             * 403 suspended and 429 rate-limit responses are
             * terminal for this submission. The frontend must
             * never blindly submit the same scene again.
             */
            retryable: false,
          },
          {
